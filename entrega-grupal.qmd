...
"CS"="#f64901","CiU"="orange", "PNV"="#2a8243", "ERC"= "#fbbc00", "BNG"="#76b3dd","Compromís"="#d85127", 
"Más País"="#00e2c6")# creando paleta personalizada con colores oficiales de los logos de los partidos que usaremos.
```
...
votos_elecciones <- datos_elecciones_tidy |> 
  ...
  mutate(siglas = fct_reorder(siglas, votos))

ggplot(votos_elecciones, aes(x = siglas, y = votos, fill = siglas)) +
