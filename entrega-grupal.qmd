...
author: "Daniel García Rodriguez de Sepúlveda (DNI: 70829427-F), Rosalía (DNI: 00000000-X), ..."
format:
  html:
    theme: [style.scss]
    toc: true
...
datos_elecciones_tidy <-
  ...
  mutate(siglas = case_when(str_detect( partido, "SOCIALIST") ~ "PSOE",
                            ...
                            str_detect(partido,"BLOQUE NACIONALISTA GALEGO| ESQUERRA REPUBLICANA DE CATALUNYA |PARTIDO NACIONALISTA VASCO | EUSKAL HERRIA BILDU" ) ~ "NACIONALISTAS",
                            TRUE ~ "OTROS" ))
```
